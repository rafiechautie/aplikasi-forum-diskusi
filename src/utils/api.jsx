const api = (() => {
  ...
  // untuk menampilkan data profile butuh token yang membuktikan kalau dia udah login, makanya dibuat fungsi fetchWithAuth
  ...
  async function upVoteComments(threadId, commentId) {
